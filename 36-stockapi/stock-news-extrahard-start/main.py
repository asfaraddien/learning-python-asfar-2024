...
email = "asfar.addien@gmail.com"
passw = "wwkd tpvs mexb wpvn"


STOCK = "TSLA"
COMPANY_NAME = "Tesla Inc"

api_key_st = "36YUJWBNRUYZCPQU"
end_st = 'https://www.alphavantage.co/query'

api_key_nw = "b65e3eaeffa14d978dd61a33b07eb84e"
end_nw = f"https://newsapi.org/v2/everything?qInTitle={COMPANY_NAME}&apiKey={api_key_nw}&pageSize=3"

def send(pers, ber, desc):
    with smtplib.SMTP("smtp.gmail.com", 587) as post:
        post.starttls()
        post.login(email, passw)
        post.sendmail(email, email, f"subject:Update!\n\nberubah {pers}\n\nberita: {ber}\n{desc}")
...
# now_month = now.month
# now_day = now.day
# now = f"{now_year}-{now_month}-{now_day}"
...
beda = yest - yest2
pers = (yest - yest2)/yest*100
if beda >= 5/100 * yest:
    print(yest)
    print(yest2)
    print(pers)

    res2 = requests.get(end_nw)
    data2 = res2.json()["articles"]
...
# Send a seperate message with the percentage change and each article's title and description to your phone number.
    send(pers, obs2[0]["title"], obs2[0]["description"])
